...
- [encryption](nbREADME.md#password-protected-encrypted-notes-and-bookmarks),
- [filtering](nbREADME.md#listing-notes) and [search](nbREADME.md#-search),
- [Git](https://git-scm.com/)-backed [versioning](nbREADME.md#-revision-history) and [syncing](nbREADME.md#-git-sync),
- [Pandoc](https://pandoc.org/)-backed [conversion](nbREADME.md#%EF%B8%8F-import--export),
- global and local [notebooks](nbREADME.md#-notebooks),
- customizable [color themes](nbREADME.md#-color-themes),
- extensibility through [plugins](nbREADME.md#-plugins),
...
[Optional dependencies](nbREADME.md#optional) can be installed to enhance functionality,
...
Zsh. On Ubuntu and WSL, you can run [`sudo nb env install`](nbREADME.md#env) to install
...
the latest version using the [`nb update`](nbREADME.md#update) subcommand.
...
[local notebooks](nbREADME.md#global-and-local-notebooks).

### 📝 Notes

#### Adding Notes

Use [`nb add`](nbREADME.md#add) to create new notes:
...
`$EDITOR` environment variable or [`nb set editor`](nbREADME.md#editor).
...
like using [`nb set default_extension`](nbREADME.md#default_extension).
...
For a full list of options available for `nb add`, run [`nb help add`](nbREADME.md#add).

##### Password-Protected Encrypted Notes and Bookmarks

Password-protected notes and [bookmarks](nbREADME.md#-bookmarks) are created with
...
[`nb set encryption_tool`](nbREADME.md#encryption_tool).
...
To list notes and notebooks, run [`nb ls`](nbREADME.md#ls):
...
[`nb set header`](nbREADME.md#header) and
[`nb set footer`](nbREADME.md#footer).
...
For full text search, see [Search](nbREADME.md#-search).
...
limit can be changed with [`nb set limit <number>`](nbREADME.md#limit).
...
`nb ls` is a combination of [`nb notebooks`](nbREADME.md#notebooks) and [`nb list`](nbREADME.md#list)
...
For more information about options for listing notes, run [`nb help ls`](nbREADME.md#ls)
and [`nb help list`](nbREADME.md#list).

#### Editing Notes

You can edit a note in your editor by passing its id, filename, or title
to [`nb edit`](nbREADME.md#edit):
...
For `nb edit` help information, run [`nb help edit`](nbREADME.md#edit).

#### Viewing Notes

Notes can be viewed using [`nb show`](nbREADME.md#show):
...
`nb show` also provides [options](nbREADME.md#show) for querying information about an
...
use [`nb open`](nbREADME.md#open).

For full `nb show` usage information, run [`nb help show`](nbREADME.md#show).
...
For `nb delete` help information, run [`nb help delete`](nbREADME.md#delete).
...
text search with [`nb search`](nbREADME.md#search). When `pandoc` is installed, the
...
Search for tagged bookmarks with [`nb search` / `nb q`](nbREADME.md#search):
...
[`nb bookmark`](nbREADME.md#bookmark) and `nb bookmark list` can be used to list
...
Use the [`--type <type>` / `--<type>`](nbREADME.md#ls) option as a filter to display
only bookmarks:
...
For more listing options, see [`nb help ls`](nbREADME.md#ls), [`nb help list`](nbREADME.md#list),
and [`nb help bookmark`](nbREADME.md#bookmark).
...
[`nb open`](nbREADME.md#open) opens the bookmarked page in your
...
[`nb peek`](nbREADME.md#peek) (alias: `preview`) opens the bookmarked page
...
[`nb` Markdown Bookmark File Format](nbREADME.md#nb-markdown-bookmark-file-format).

#### `bookmark` -- A command line tool for managing bookmarks.

`nb` includes [`bookmark`](nbREADME.md#bookmark-help), a full-featured command line
...
See [`bookmark help`](nbREADME.md#bookmark-help) for more information.

### 🔍 Search

Use [`nb search`](nbREADME.md#search) to search your notes, with support for
...
For more information about search, see [`nb help search`](nbREADME.md#search).
...
Use [`nb history`](nbREADME.md#history) to view the history of the notebook or an
individual note:
...
Create a new notebook with [`nb notebooks add`](nbREADME.md#notebooks):
...
To switch to a different notebook, use [`nb use`](nbREADME.md#use):
...
[`nb` tab completion](nbREADME.md#tab-completion) is optimized for frequently running
...
[`nb search`](nbREADME.md#search) / [`nb q`](nbREADME.md#search):
...
stored in the directory configured in [`nb set nb_dir`](nbREADME.md#nb_dir), which is
`~/.nb` by default.
...
Local notebooks can be created with [`nb notebooks init`](nbREADME.md#notebooks):
...
Notebooks can be archived using [`nb notebooks archive`](nbREADME.md#notebooks):
...
When a notebook is archived it is not included in [`nb`](nbREADME.md#ls) /
[`nb ls`](nbREADME.md#ls) output, [`nb search --all`](nbREADME.md#search), or tab completion,
nor synced automatically with [`nb sync --all`](nbREADME.md#sync).
...
[`nb notebooks status`](nbREADME.md#notebooks):
...
Use [`nb notebooks unarchive`](nbREADME.md#notebooks) to unarchive a notebook:
...
[`nb help notebooks`](nbREADME.md#notebooks).

For technical details about notebooks, see
[`nb` Notebook Specification](nbREADME.md#nb-notebook-specification).

### 🔄 Git Sync

Each notebook can be synced with a remote git repository by setting the
remote URL using [`nb remote`](nbREADME.md#remote):
...
your `nb` directory with [`nb set nb_dir <path>`](nbREADME.md#nb_dir)
and git syncing will still work simultaneously.

When you have an existing `nb` notebook in a git repository, simply
pass the URL to [`nb notebooks add`](nbREADME.md#notebooks) and `nb` will clone
...
[`nb set auto_sync`](nbREADME.md#auto_sync) and sync manually with
[`nb sync`](nbREADME.md#sync).
...
When [`nb sync`](nbREADME.md#sync) encounters a conflict in a text file and can't
...
Use [`nb edit`](nbREADME.md#edit) to remove the conflict markers and delete any
unwanted text.
...
[`nb git`](nbREADME.md#git) and [`nb run`](nbREADME.md#run) can be used to perform git and
...
[`nb import`](nbREADME.md#import). [`nb edit`](nbREADME.md#edit) and [`nb open`](nbREADME.md#open) will open
...
Notes, bookmarks, and other files can be exported using [`nb export`](nbREADME.md#export).
...
[`nb export pandoc`](nbREADME.md#export) subcommand:
...
[`nb export notebook`](nbREADME.md#export) and [`nb import notebook`](nbREADME.md#import) can be
...
[`nb export notebook`](nbREADME.md#export) and [`nb import notebook`](nbREADME.md#import) behave
like aliases for [`nb notebooks export`](nbREADME.md#notebooks) and
[`nb notebooks import`](nbREADME.md#notebooks), and the subcommands can be used
interchangeably.

For more information about imported and exported notebooks, see
[Global and Local Notebooks](nbREADME.md#global-and-local-notebooks).

For `nb import` and `nb export` help information, see
[`nb help import`](nbREADME.md#import) and [`nb help export`](nbREADME.md#export).

### ⚙️ `set` & Settings

[`nb set`](nbREADME.md#settings) and [`nb settings`](nbREADME.md#settings) open the settings
...
name or number to [`nb set`](nbREADME.md#settings):
...
Use [`nb settings get`](nbREADME.md#settings) to print the value of a setting:
...
Use [`nb settings unset`](nbREADME.md#settings) to unset a setting and revert to
the default:
...
[`nb help settings`](nbREADME.md#settings) and
[`nb settings list --long`](nbREADME.md#settings-list---long).
...
[`nb set color_theme`](nbREADME.md#color_theme):
...
Color themes are [`nb` plugins](nbREADME.md#-plugins) with a `.nb-theme` file
...
Themes can be installed using [`nb plugins`](nbREADME.md#plugins):
...
Once a theme is installed, use [`nb set color_theme`](nbREADME.md#color_theme) to set it
...
theme, use [`nb set syntax_theme`](nbREADME.md#syntax_theme).
...
Plugins are managed with the [`nb plugins`](nbREADME.md#plugins) subcommand and
are installed in the `${NB_DIR}/.plugins` directory.

Plugins can be installed from either a URL or a path using the
[`nb plugins install`](nbREADME.md#plugins) subcommand.
...
Installed plugins can be listed with [`nb plugins`](nbREADME.md#plugins), which
...
Use [`nb plugins uninstall`](nbREADME.md#plugins) to uninstall a plugin:
...
The `nb` API is the [command line interface](nbREADME.md#nb-help), which is designed for
...
[`nb` notebooks](nbREADME.md#-notebooks) can be selected by the user on a per-command
...
any subcommand options. Use [`show <selector>`](nbREADME.md#show) to query
...
[`notebooks current --path`](nbREADME.md#notebooks) returns the path to the current
notebook:
...
See
[`copy.nb-plugin`](https://github.com/xwmx/nb/blob/master/plugins/copy.nb-plugin)
for a practical example using both [`show <selector> --filename`](nbREADME.md#show) and
[`notebooks current --path`](nbREADME.md#notebooks) along with other
...
[`nb shell`](nbREADME.md#shell), `nb -i`, or `nb --interactive`:
